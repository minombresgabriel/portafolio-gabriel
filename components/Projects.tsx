...
import { FaGithub, FaCreditCard, FaShieldAlt } from 'react-icons/fa';
import { motion } from 'framer-motion';
import { useLanguage } from '@/lib/i18n/LanguageContext';

const placeholderIcons = {
  payment: <FaCreditCard className="text-7xl text-cyan-400 drop-shadow-[0_0_20px_#00f0ff]" />,
  security: <FaShieldAlt className="text-7xl text-purple-400 drop-shadow-[0_0_20px_#a855f7]" />,
};
              ...
              >
                ...
                {proj.image ? (
                  <div className="relative w-full overflow-hidden">
                    <Image
                      ...
                      width={800}
                      height={300}
                      className="w-full object-cover object-top transition-transform duration-700 ease-in-out group-hover:scale-105"
                      priority
                  ...
                  <div
                    className={`relative w-full h-44 flex flex-col items-center justify-center gap-3 bg-gradient-to-br ${proj.placeholder.gradient} transition-opacity duration-500 group-hover:opacity-90`}
                  >
                    {placeholderIcons[proj.placeholder.icon]}
                    <span className="text-xs tracking-widest uppercase text-gray-400 font-semibold">
                      {t.projects.proprietary_label}
                    </span>
                  </div>
                ) : null}
                ...
                <div className="flex flex-col flex-1 p-6">
                  ...
                  {proj.github && (
                    ...
                    >
                      <FaGithub className="text-lg" /> {t.projects.github_label}
                    </a>
                  )}
                </div>
              </motion.article>
